...
// Coding Statistics Collection
export const CodingStatsSchema = {
  _id: "ObjectId", // MongoDB ObjectId
  userId: "String", // Reference to user ID (unique per user)
  problemsSolved: "Number", // Total number of problems solved
  timeSpentMinutes: "Number", // Total time spent in minutes
  currentStreak: "Number", // Current streak in days
  longestStreak: "Number", // Longest streak achieved
  lastSolvedDate: "Date?", // Date of last problem solved
  solvedProblems: "Object[]", // Array of { problemId: string, solvedAt: Date, timeSpent: number }
  createdAt: "Date",
  updatedAt: "Date"
};
